...
public class ArenaWindowController implements Initializable {
    ...
    public void displayHowToPlay() {
        ...
        picture1.setFill(AssetManagerBoids.normalBirds(1, 0));
        picture1.setX(50);
        picture1.setY(330);
        addToPane(picture1);
        picture2 = new Rectangle(80, 80);
        picture2.setFill(AssetManagerBoids.flippedPredators(2));
        picture2.setX(850);
        picture2.setY(450);
        addToPane(picture2);
        picture3 = new Rectangle(80, 80);
        picture3.setFill(AssetManagerBoids.normalScaryPredators(2));
        picture3.setX(50);
        picture3.setY(570);
        addToPane(picture3);
        picture4 = new Rectangle(120, 120);
        picture4.setFill(AssetManagerBoids.playerGoingUp(4, true));
        picture4.setX(850);
        picture4.setY(750);
        addToPane(picture4);
    ...
    public void displayHowToPlayPage2() {
        ...
        picture1.setFill(AssetManagerBoids.mastSkin(false));
        picture1.setX(30);
        picture1.setY(230);
        addToPane(picture1);
        picture2 = new Rectangle(70, 70);
        picture2.setFill(AssetManagerBoids.mastSkin(true));
        picture2.setX(80);
        picture2.setY(300);
        addToPane(picture2);
        picture3 = new Rectangle(150, 30);
        picture3.setFill(AssetManagerBoids.springSkin(true));
        picture3.setX(810);
        picture3.setY(470);
        addToPane(picture3);
        picture4 = new Rectangle(100, 100);
        picture4.setFill(AssetManagerBoids.spikeSkin(3));
        picture4.setX(80);
        picture4.setY(610);
        addToPane(picture4);
    }
    ...
    public void displaySettings() {
        ...
        boidsSettings.setBackground(AssetManagerBoids.getButtonBoid(0, 250, 250));
        predatorSettings.setVisible(true);
        predatorSettings.setText("\n\n\n\n\nPredator Settings");
        predatorSettings.setBackground(AssetManagerBoids.getButtonPredator(0, 250, 250));
        playerSettings.setVisible(true);
        playerSettings.setText("\n\n\n\n\nPlayer Settings");
        playerSettings.setBackground(AssetManagerBoids.getButtonPlayer(0, 250, 250));
        arenaSettings.setVisible(true);
        arenaSettings.setText("\n\n\n\n\nArena Settings");
        arenaSettings.setBackground(AssetManagerBoids.getButtonArena(0, 250, 250));
    ...
    public void displayPredatorSettings() {
        ...
        picture1.setFill(AssetManagerBoids.normalPredators(2));
        picture1.setX(200);
        picture1.setY(200);
        addToPane(picture1);
        ...
        picture2.setFill(AssetManagerBoids.flippedScaryPredators(2));
        picture2.setX(700);
        picture2.setY(200);
        addToPane(picture2);
    ...
    public void displayPlayerSettings() {
        ...
        picture1.setFill(AssetManagerBoids.playerGoingUp(1, true));
        picture1.setX(117.6);
        picture1.setY(250);
        addToPane(picture1);
        //displays player 2 picture
        picture2 = new Rectangle(103, 90);
        picture2.setFill(AssetManagerBoids.playerGoingUp(2, true));
        picture2.setX(338.2);
        picture2.setY(250);
        addToPane(picture2);
        //displays player 3 picture
        picture3 = new Rectangle(103, 90);
        picture3.setFill(AssetManagerBoids.playerGoingUp(3, true));
        picture3.setX(558.8);
        picture3.setY(250);
        addToPane(picture3);
    ...
    public void displayArenaSettings() {
        ...
        picture2.setFill(AssetManagerBoids.springSkin(true));
        addToPane(picture2);
    ...
    public void startGame() throws IOException {
        Parent root = FXMLLoader.load(getClass().getResource("FXMLDocumentBoids.fxml"));
        Rectangle2D screenBounds = Screen.getPrimary().getVisualBounds();
    ...
    public void showWinners() {
        ...
        if (ArenaSetup.p1.isReal) {
            ...
            picture1.setFill(AssetManagerBoids.playerOrbSprites(1, 1));
        }
        picture1.setX(200);
        picture1.setY(200);
        addToPane(picture1);
        ...
        if (ArenaSetup.p2.isReal) {
            ...
            picture2.setFill(AssetManagerBoids.playerOrbSprites(2, 1));
        }
        picture2.setX(600);
        picture2.setY(200);
        addToPane(picture2);
        ...
        if (ArenaSetup.p3.isReal) {
            ...
            picture3.setFill(AssetManagerBoids.playerOrbSprites(3, 1));
        }
        picture3.setX(200);
        picture3.setY(600);
        addToPane(picture3);
        ...
        if (ArenaSetup.p4.isReal) {
            ...
            picture4.setFill(AssetManagerBoids.playerOrbSprites(4, 1));
        }
        picture4.setX(600);
        picture4.setY(600);
        addToPane(picture4);
    ...
    public void settingUpButtons() {
        ...
        backButton.setBackground(AssetManagerBoids.getButtonDefault(100, 100));
        ...
        gameSettingsButton.setBackground(AssetManagerBoids.getButtonDefault(450, 290));
        ...
        howToPlayButton.setBackground(AssetManagerBoids.getButtonDefault(450, 290));
        ...
        backToMenuButton.setBackground(AssetManagerBoids.getButtonDefault(150, 100));
        ...
        startGameButton.setVisible(false);
        startGameButton.setBackground(AssetManagerBoids.getButtonDefault(500, 150));

        backToSettingsButton.setLayoutX(5);
        backToSettingsButton.setLayoutY(5);
        backToSettingsButton.setVisible(false);
        backToSettingsButton.setBackground(AssetManagerBoids.getButtonDefault(200, 100));
        ...
        infoRectangle.setFill(AssetManagerBoids.getInfoMenuBackground());
        infoRectangle.setVisible(false);
    ...
    public void initialize(URL url, ResourceBundle rb) {
        //setting background
        AssetManagerBoids.getAllGameAssets();
        panel.setBackground(AssetManagerBoids.getMenuBackgroundImage(screenWidth + 10, screenHeight + 40));
        settingUpButtons();
        ...
        new AnimationTimer() {
            ...
            public void handle(long now) {
                ...
                if (onBoidsSetting && (counter % 10.0 == 0)) {
                    ...
                    boidsSettings.setBackground(AssetManagerBoids.getButtonBoid(animationBoid, 250, 250));
                }
                if (onPredatorSettings && (counter % 10 == 0)) {
                    ...
                    predatorSettings.setBackground(AssetManagerBoids.getButtonPredator(animationPredator, 250, 250));
                }
                if (onPlayerSettings && (counter % 10.0 == 0)) {
                    ...
                    playerSettings.setBackground(AssetManagerBoids.getButtonPlayer(animationPlayer, 250, 250));
                }
                if (onArenaSettings && (counter % 20.0 == 0)) {
                    ...
                    arenaSettings.setBackground(AssetManagerBoids.getButtonArena(animationArena, 250, 250));
                }
                ...
                if ((isOnResultPage) && (counter % 10 == 0)) {
                    for (Integer numbers : ArenaSetup.winnerPlayer) {
                        switch (numbers) {
                            case 1:
                                picture1.setFill(AssetManagerBoids.playerGoingUp(1, animationWinner));
                                break;
                            case 2:
                                picture2.setFill(AssetManagerBoids.playerGoingUp(2, animationWinner));
                                break;
                            case 3:
                                picture3.setFill(AssetManagerBoids.playerGoingUp(3, animationWinner));
                                break;
                            case 4:
                                picture4.setFill(AssetManagerBoids.playerGoingUp(4, animationWinner));
                                break;
                        }
                    }

...
public class Predator {
    ...
    public void animation(boolean isNormalPredator, int animationPredator) {
        if (isNormalPredator) {
            if (velocity.getX() < 0) {
                rect.setFill(AssetManagerBoids.flippedPredators(animationPredator));
            } else {
                rect.setFill(AssetManagerBoids.normalPredators(animationPredator));
            }
        } else {
            if (velocity.getX() < 0) {
                rect.setFill(AssetManagerBoids.flippedScaryPredators(animationPredator));
            } else {
                rect.setFill(AssetManagerBoids.normalScaryPredators(animationPredator));
            }
        }
    }

 ...
 * @author Pegasus
 */
public class AssetManagerBoids {
    ...
    //pre-loads all assetsBoids
    static public void getAllGameAssets() {
        //importing background
        background = new Image(fileURL("./assetsBoids/Background, Mast, Spring and Spike/backgroundWaterfall.gif"));
        menuBackground = new Image(fileURL("./assetsBoids/Background, Mast, Spring and Spike/mBackground.png"));
        //importing menu rectangle background
        menuBack = new ImagePattern(new Image(fileURL("./assetsBoids/Background, Mast, Spring and Spike/Scroll.png")));

        //importing yellow bird sprites
        yellowBirdDown = new ImagePattern(new Image(fileURL("./assetsBoids/Boids/yellowbird-downflap.png")));
        yellowBirdMid = new ImagePattern(new Image(fileURL("./assetsBoids/Boids/yellowbird-midflap.png")));
        yellowBirdUp = new ImagePattern(new Image(fileURL("./assetsBoids/Boids/yellowbird-upflap.png")));
        //importing blue bird sprites
        blueBirdDown = new ImagePattern(new Image(fileURL("./assetsBoids/Boids/bluebird-downflap.png")));
        blueBirdMid = new ImagePattern(new Image(fileURL("./assetsBoids/Boids/bluebird-midflap.png")));
        blueBirdUp = new ImagePattern(new Image(fileURL("./assetsBoids/Boids/bluebird-upflap.png")));
        //importing red bird sprites
        redBirdDown = new ImagePattern(new Image(fileURL("./assetsBoids/Boids/redbird-downflap.png")));
        redBirdMid = new ImagePattern(new Image(fileURL("./assetsBoids/Boids/redbird-midflap.png")));
        redBirdUp = new ImagePattern(new Image(fileURL("./assetsBoids/Boids/redbird-upflap.png")));
        //importing predator sprites
        predatorDown = new ImagePattern(new Image(fileURL("./assetsBoids/Predator/Predator-1.png")));
        predatorLowMid = new ImagePattern(new Image(fileURL("./assetsBoids/Predator/Predator-2.png")));
        predatorHighMid = new ImagePattern(new Image(fileURL("./assetsBoids/Predator/Predator-3.png")));
        predatorHigh = new ImagePattern(new Image(fileURL("./assetsBoids/Predator/Predator-4.png")));
        //importing Scary predator sprites
        scaryPredatorDown = new ImagePattern(new Image(fileURL("./assetsBoids/Predator/ScaryPredator-1.png")));
        scaryPredatorLowMid = new ImagePattern(new Image(fileURL("./assetsBoids/Predator/ScaryPredator-2.png")));
        scaryPredatorHighMid = new ImagePattern(new Image(fileURL("./assetsBoids/Predator/ScaryPredator-3.png")));
        scaryPredatorHigh = new ImagePattern(new Image(fileURL("./assetsBoids/Predator/ScaryPredator-4.png")));

        //importing flipped yellow bird sprites
        flippedYellowBirdDown = new ImagePattern(new Image(fileURL("./assetsBoids/Boids/Flipped-yellowbird-downflap.png")));
        flippedYellowBirdMid = new ImagePattern(new Image(fileURL("./assetsBoids/Boids/Flipped-yellowbird-midflap.png")));
        flippedYellowBirdUp = new ImagePattern(new Image(fileURL("./assetsBoids/Boids/Flipped-yellowbird-upflap.png")));
        //importing blue flipped bird sprites
        flippedBlueBirdDown = new ImagePattern(new Image(fileURL("./assetsBoids/Boids/Flipped-bluebird-downflap.png")));
        flippedBlueBirdMid = new ImagePattern(new Image(fileURL("./assetsBoids/Boids/Flipped-bluebird-midflap.png")));
        flippedBlueBirdUp = new ImagePattern(new Image(fileURL("./assetsBoids/Boids/Flipped-bluebird-upflap.png")));
        //importing red flipped bird sprites
        flippedRedBirdDown = new ImagePattern(new Image(fileURL("./assetsBoids/Boids/Flipped-redbird-downflap.png")));
        flippedRedBirdMid = new ImagePattern(new Image(fileURL("./assetsBoids/Boids/Flipped-redbird-midflap.png")));
        flippedRedBirdUp = new ImagePattern(new Image(fileURL("./assetsBoids/Boids/Flipped-redbird-upflap.png")));
        //importing flipped predators
        flippedPredatorDown = new ImagePattern(new Image(fileURL("./assetsBoids/Predator/Flipped-Predator-1.png")));
        flippedPredatorLowMid = new ImagePattern(new Image(fileURL("./assetsBoids/Predator/Flipped-Predator-2.png")));
        flippedPredatorHighMid = new ImagePattern(new Image(fileURL("./assetsBoids/Predator/Flipped-Predator-3.png")));
        flippedPredatorHigh = new ImagePattern(new Image(fileURL("./assetsBoids/Predator/Flipped-Predator-4.png")));
        //importing flipped predators
        flippedScaryPredatorDown = new ImagePattern(new Image(fileURL("./assetsBoids/Predator/Flipped-ScaryPredator-1.png")));
        flippedScaryPredatorLowMid = new ImagePattern(new Image(fileURL("./assetsBoids/Predator/Flipped-ScaryPredator-2.png")));
        flippedScaryPredatorHighMid = new ImagePattern(new Image(fileURL("./assetsBoids/Predator/Flipped-ScaryPredator-3.png")));
        flippedScaryPredatorHigh = new ImagePattern(new Image(fileURL("./assetsBoids/Predator/Flipped-ScaryPredator-4.png")));

        //importing mast
        mast = new ImagePattern(new Image(fileURL("./assetsBoids/Background, Mast, Spring and Spike/log.png")));
        closestMast = new ImagePattern(new Image(fileURL("./assetsBoids/Background, Mast, Spring and Spike/closest log.png")));

        //importing springs
        springs = new ImagePattern(new Image(fileURL("./assetsBoids/Background, Mast, Spring and Spike/Spring.png")));
        springBounced = new ImagePattern(new Image(fileURL("./assetsBoids/Background, Mast, Spring and Spike/Spring - boing.png")));

        //importing spikes
        spike = new ImagePattern(new Image(fileURL("./assetsBoids/Background, Mast, Spring and Spike/Spike.png")));
        spikeFlipped = new ImagePattern(new Image(fileURL("./assetsBoids/Background, Mast, Spring and Spike/Spike - Flipped.png")));
        spikeUpwards = new ImagePattern(new Image(fileURL("./assetsBoids/Background, Mast, Spring and Spike/Spike - UpFlip.png")));

        //importing player 1
        player1GoingUp = new ImagePattern(new Image(fileURL("./assetsBoids/Player-1/Up.png")));
        player1GoingDown = new ImagePattern(new Image(fileURL("./assetsBoids/Player-1/Down.png")));
        player1Swing = new ImagePattern(new Image(fileURL("./assetsBoids/Player-1/Swing.png")));
        //importing player 2
        player2GoingUp = new ImagePattern(new Image(fileURL("./assetsBoids/Player-2/Up.png")));
        player2GoingDown = new ImagePattern(new Image(fileURL("./assetsBoids/Player-2/Down.png")));
        player2Swing = new ImagePattern(new Image(fileURL("./assetsBoids/Player-2/Swing.png")));
        //importing player 3
        player3GoingUp = new ImagePattern(new Image(fileURL("./assetsBoids/Player-3/Up.png")));
        player3GoingDown = new ImagePattern(new Image(fileURL("./assetsBoids/Player-3/Down.png")));
        player3Swing = new ImagePattern(new Image(fileURL("./assetsBoids/Player-3/Swing.png")));
        //importing player 4
        player4GoingUp = new ImagePattern(new Image(fileURL("./assetsBoids/Player-4/Up.png")));
        player4GoingDown = new ImagePattern(new Image(fileURL("./assetsBoids/Player-4/Down.png")));
        player4Swing = new ImagePattern(new Image(fileURL("./assetsBoids/Player-4/Swing.png")));

        //importing orb-player line
        orbLine1 = new ImagePattern(new Image(fileURL("./assetsBoids/Player-1/P-1 Line.png")));
        orbLine2 = new ImagePattern(new Image(fileURL("./assetsBoids/Player-2/P-2 Line.png")));
        orbLine3 = new ImagePattern(new Image(fileURL("./assetsBoids/Player-3/P-3 Line.png")));
        orbLine4 = new ImagePattern(new Image(fileURL("./assetsBoids/Player-4/P-4 Line.png")));
        ...
        player1Orb.add(new ImagePattern(new Image(fileURL("./assetsBoids/Player-1/P-1 A-1.png"))));
        player1Orb.add(new ImagePattern(new Image(fileURL("./assetsBoids/Player-1/P-1 A-2.png"))));
        player1Orb.add(new ImagePattern(new Image(fileURL("./assetsBoids/Player-1/P-1 A-3.png"))));
        player1Orb.add(new ImagePattern(new Image(fileURL("./assetsBoids/Player-1/P-1 A-4.png"))));
        player1Orb.add(new ImagePattern(new Image(fileURL("./assetsBoids/Player-1/P-1 A-5.png"))));
        player1Orb.add(new ImagePattern(new Image(fileURL("./assetsBoids/Player-1/P-1 A-6.png"))));
        player1Orb.add(new ImagePattern(new Image(fileURL("./assetsBoids/Player-1/P-1 A-7.png"))));
        player1Orb.add(new ImagePattern(new Image(fileURL("./assetsBoids/Player-1/P-1 A-8.png"))));

        //add sprites to player 2 orb Arraylist
        player2Orb.add(new ImagePattern(new Image(fileURL("./assetsBoids/Player-2/P-1 A-1.png"))));
        player2Orb.add(new ImagePattern(new Image(fileURL("./assetsBoids/Player-2/P-1 A-2.png"))));
        player2Orb.add(new ImagePattern(new Image(fileURL("./assetsBoids/Player-2/P-1 A-3.png"))));
        player2Orb.add(new ImagePattern(new Image(fileURL("./assetsBoids/Player-2/P-1 A-4.png"))));
        player2Orb.add(new ImagePattern(new Image(fileURL("./assetsBoids/Player-2/P-1 A-5.png"))));
        player2Orb.add(new ImagePattern(new Image(fileURL("./assetsBoids/Player-2/P-1 A-6.png"))));
        player2Orb.add(new ImagePattern(new Image(fileURL("./assetsBoids/Player-2/P-1 A-7.png"))));
        player2Orb.add(new ImagePattern(new Image(fileURL("./assetsBoids/Player-2/P-1 A-8.png"))));

        //add sprites to player 3 orb Arraylist
        player3Orb.add(new ImagePattern(new Image(fileURL("./assetsBoids/Player-3/P-1 A-1.png"))));
        player3Orb.add(new ImagePattern(new Image(fileURL("./assetsBoids/Player-3/P-1 A-2.png"))));
        player3Orb.add(new ImagePattern(new Image(fileURL("./assetsBoids/Player-3/P-1 A-3.png"))));
        player3Orb.add(new ImagePattern(new Image(fileURL("./assetsBoids/Player-3/P-1 A-4.png"))));
        player3Orb.add(new ImagePattern(new Image(fileURL("./assetsBoids/Player-3/P-1 A-5.png"))));
        player3Orb.add(new ImagePattern(new Image(fileURL("./assetsBoids/Player-3/P-1 A-6.png"))));
        player3Orb.add(new ImagePattern(new Image(fileURL("./assetsBoids/Player-3/P-1 A-7.png"))));
        player3Orb.add(new ImagePattern(new Image(fileURL("./assetsBoids/Player-3/P-1 A-8.png"))));

        //add sprites to player 4 orb Arraylist
        player4Orb.add(new ImagePattern(new Image(fileURL("./assetsBoids/Player-4/P-1 A-1.png"))));
        player4Orb.add(new ImagePattern(new Image(fileURL("./assetsBoids/Player-4/P-1 A-2.png"))));
        player4Orb.add(new ImagePattern(new Image(fileURL("./assetsBoids/Player-4/P-1 A-3.png"))));
        player4Orb.add(new ImagePattern(new Image(fileURL("./assetsBoids/Player-4/P-1 A-4.png"))));
        player4Orb.add(new ImagePattern(new Image(fileURL("./assetsBoids/Player-4/P-1 A-5.png"))));
        player4Orb.add(new ImagePattern(new Image(fileURL("./assetsBoids/Player-4/P-1 A-6.png"))));
        player4Orb.add(new ImagePattern(new Image(fileURL("./assetsBoids/Player-4/P-1 A-7.png"))));
        player4Orb.add(new ImagePattern(new Image(fileURL("./assetsBoids/Player-4/P-1 A-8.png"))));

        //**// BUTTONS //**//
        //boids
        buttonRedBirdDown = new Image(fileURL("./assetsBoids/Button/redbird-downflap.png"));
        buttonRedBirdMid = new Image(fileURL("./assetsBoids/Button/redbird-midflap.png"));
        buttonRedBirdUp = new Image(fileURL("./assetsBoids/Button/redbird-upflap.png"));
        //predator
        buttonPredatorDown = new Image(fileURL("./assetsBoids/Button/Flipped-Predator-1.png"));
        buttonPredatorLowMid = new Image(fileURL("./assetsBoids/Button/Flipped-Predator-2.png"));
        buttonPredatorHighMid = new Image(fileURL("./assetsBoids/Button/Flipped-Predator-3.png"));
        buttonPredatorHigh = new Image(fileURL("./assetsBoids/Button/Flipped-Predator-4.png"));
        ...
        buttonPlayer.add(new Image(fileURL("./assetsBoids/Button/P-1 A-1.png")));
        buttonPlayer.add(new Image(fileURL("./assetsBoids/Button/P-1 A-2.png")));
        buttonPlayer.add(new Image(fileURL("./assetsBoids/Button/P-1 A-3.png")));
        buttonPlayer.add(new Image(fileURL("./assetsBoids/Button/P-1 A-4.png")));
        buttonPlayer.add(new Image(fileURL("./assetsBoids/Button/P-1 A-5.png")));
        buttonPlayer.add(new Image(fileURL("./assetsBoids/Button/P-1 A-6.png")));
        buttonPlayer.add(new Image(fileURL("./assetsBoids/Button/P-1 A-7.png")));
        buttonPlayer.add(new Image(fileURL("./assetsBoids/Button/P-1 A-8.png")));
        //add sprites to the arena arraylist
        buttonArena.add(new Image(fileURL("./assetsBoids/Button/Spike1.png")));
        buttonArena.add(new Image(fileURL("./assetsBoids/Button/Spike2.png")));
        //scroll
        scroll = new Image(fileURL("./assetsBoids/Button/scroll2.png"));

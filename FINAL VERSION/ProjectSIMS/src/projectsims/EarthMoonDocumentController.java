...
//	Rectangle rect;
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        Background background = AssetManagerSolar.getBackgroundImage();
        //set background gif
        ...
        Earth.setFill(AssetManagerSolar.getEarthImage());
        Moon.setFill(AssetManagerSolar.getMoonImage()); //Get a moon image

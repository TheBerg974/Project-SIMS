...
public class SimulationPhysics {
	...
	*/
	// public Vector2D applyNewtonsLaw(Vector2D Force) {
	 ...
	 */
	public Vector2D newtonsLaw(double mass1, double mass2, double distanceX, double distanceY, CelestialBody firstBody, CelestialBody otherBody) {

...
public class SimulationPhysics {
	 ...
	 */
	static final double UNIV_GRAV_CONSTANT = 6.64 * 1000;
    ...
    public static Vector2D newtonsLaw(CelestialBody firstBody, CelestialBody otherBody) {
        ...
        double vectorMagnitude = (UNIV_GRAV_CONSTANT * firstBody.getMass() * otherBody.getMass())/Math.pow(distanceTotal,2); //Gm1m2/r^2
